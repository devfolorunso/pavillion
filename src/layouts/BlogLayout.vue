	...
	<q-layout view="hHh lpR fFf" class="bg-grey-1">
		<q-header elevated class="bg-white text-grey-8" height-hint="64">
			<q-toolbar class="GNL__toolbar">
				...
				>
					<span class="q-ml-sm">Pav Blog</span>
				</q-toolbar-title>
				...
				<q-list padding class="text-grey-8">
					...
					>
						<q-item-section avatar>
							<q-icon size="15px" :name="link.icon" />
						</q-item-section>
						<q-item-section>
...
export default defineComponent({
	...
	setup() {
		...
		return {
			...
			byWebsite,
			links1: [
				{ icon: "edit", text: "New Blog", path: "/blog/create" },
				{ icon: "web", text: "All Blogs", path: "/blog/list-all" },
				{ icon: "person", text: "Trending", path: "#" },
				{ icon: "star_border", text: "Most Viewed", path: "#" },
			],
